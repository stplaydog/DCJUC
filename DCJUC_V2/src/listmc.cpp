...
MCList::MCList(myint b_size, myint list_size, 
		myint b, myint num_t, 
		bool is_ub, int num_elem) : MCList(b_size, list_size, b, num_t, is_ub, false, num_elem){
}


MCList::MCList(myint b_size, myint list_size, 
		myint b, myint num_t, 
		bool is_ub, bool is_enumerate_a, 
		int num_elem) : List(b_size, list_size, b, num_t, is_ub, is_enumerate_a){
	int i;
...
void 
MCList::add(lint pos, myint buck_id, 
...
void 
MCList::get(lint pos, myint buck_id, 
...
void
MCList::prepare_parallel_list(int buck_id){
	int i, j;
...
void
MCList::copy(List *other, int buck_id, int size){
	MCList *l = (MCList*)other;
...
void
MCList::print_bucket(int buck_id){
