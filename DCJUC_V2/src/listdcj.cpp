...
DCJList::DCJList(myint b_size, myint list_size, 
		myint b, myint num_t, 
...
void 
DCJList::add(lint pos, myint buck_id, 
...
void 
DCJList::get(lint pos, myint buck_id, 
...
void
DCJList::prepare_parallel_list(int buck_id){
	int i, j;
...
void
DCJList::copy(List *other, int buck_id, int size){
	DCJList *l = (DCJList*)other;
...
void
DCJList::print_bucket(int buck_id){
